...
public class NoteCustomList extends LinearLayout {
    ...
    /**
     * To show the checkbox and title of each list item
     * @param list - format: Item_name1$false%Item_name2$false%Item_name3$false
     */
    public void setUpForHomeAdapter(String list) {
        setOrientation(VERTICAL);
        String[] listEntryTokens = list.split("%");
        ...
        for(String entryDetails : listEntryTokens){
            ...
            for(int i=0; i<listEntry.length; i++){
                if(i%2 == 0){
                    ...
                    isChecked = Boolean.valueOf(listEntry[i]);
                }
            }
            CheckBox checkBox = new CheckBox(mContext);
            //mark as checked if isChecked is true
            ...
            //if the item is checked - cross out the item text
            if(isChecked) {
    ...
    /**
     * To show the checkbox, title and edit icon
     * @param listEntries
     */
    public void setUpForEditMode(String listEntries) {
        ...
        for (String entryDetails : listEntryTokens) {
            ...
            //for deleting the item from the list
            ...
            //when delete item is pressed - the item should be deleted from the list
            ...
            //when user taps the checkbox - the text should be crosses, checkbox unchecked
    ...
    public void setUpForListNotification(String listEntries) {
        ...
        for (String entryDetails : listEntryTokens) {
            ...
            if(entryDetails.contains(Constants.TRUE)) {
                listItem = entryDetails.split(Constants.TRUE)[0];
                isStrikeOut = true;
            } else if(entryDetails.contains(Constants.FALSE)){
                listItem = entryDetails.split(Constants.FALSE)[0];
                isStrikeOut = false;
            }
    ...
    /**
     * Add new checkbox when the add button pressed
     */
