...
/**
 * Created by squirrel on 12/10/15.
 */
public class AppSharedPreferences {
    ...
    public static void setUserLearned(Context context, String prefName, String prefValue) {
        android.content.SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
    ...
    public static int getUploadPreference(Context context) {
        SharedPreferences preferences = context.getSharedPreferences(Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        return preferences.getInt(Constants.IMAGE_SELECTION_STORAGE, Constants.NONE_SELECTION);
    }
    ...
    public static void setPersonalNotesPreference(Context context, int value) {
        SharedPreferences preferences = context.getSharedPreferences(
                Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt(Constants.IMAGE_SELECTION_STORAGE, value);
        editor.apply();
    }
    ...
    public static void storeGoogleDriveResourceId(Context context, String value) {
        SharedPreferences preferences = context.getSharedPreferences(
                Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString(Constants.GOOGLE_DRIVE_ID, value);
        editor.apply();
    }
    ...
    public static String getGoogleDriveResourceId(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        return sharedPreferences.getString(Constants.GOOGLE_DRIVE_ID, "");
    }
    ...
    public static void storeGoogleDriveUploadFileName(Context context, String value) {
        SharedPreferences preferences = context.getSharedPreferences(
                Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString(Constants.GOOGLE_DRIVE_UPLOAD_DIR, value);
        editor.apply();
    }
    ...
    public static String getGoogleDriveUploadPath(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        return sharedPreferences.getString(Constants.GOOGLE_DRIVE_UPLOAD_DIR, "");
    }
    ...
    public static void storeDropBoxUploadPath(Context context, String value) {
        SharedPreferences preferences = context.getSharedPreferences(
                Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString(Constants.DROP_BOX_UPLOAD_PATH, value);
        editor.apply();
    }
    ...
    public static String getDropBoxUploadPath(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        return sharedPreferences.getString(Constants.DROP_BOX_UPLOAD_PATH, "");
    }

    //this will check the authenticated state of dropbox
    public static boolean isDropBoxAuthenticated(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean(Constants.DROP_BOX_AUTH_BOOL, false);
    }
    ...
    public static void isDropBoxAuthenticated(Context context, boolean value) {
        SharedPreferences preferences = context.getSharedPreferences(
                Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean(Constants.DROP_BOX_AUTH_BOOL, value);
        editor.apply();
    }
    ...
    public static boolean isGoogleDriveAuthenticated(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean(Constants.GOOGLE_DRIVE_AUTH_BOOL, false);
    }
    ...
    public static void isGoogleDriveAuthenticated(Context context, boolean value) {
        SharedPreferences preferences = context.getSharedPreferences(
                Constants.PERSONAL_NOTES_PREFERENCE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean(Constants.GOOGLE_DRIVE_AUTH_BOOL, value);
        editor.apply();
    }
}
