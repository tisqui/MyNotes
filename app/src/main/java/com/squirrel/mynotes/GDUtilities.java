 ...
 * Can't be modified, extended, as everything is static.
 */
final public class GDUtilities {
    private static final String L_TAG = "_";

    static final String MYROOT = "PersonalNotes";
    static final String TMP_FILENM = "temp";
    static final String JPEG_EXT = Constants.JPG;
    ...
    final static class AM {
        ...
        static Account[] getAllAccnts() {
            return AccountManager.get(GDUtilities.acx).getAccountsByType(GoogleAuthUtil.GOOGLE_ACCOUNT_TYPE);
        }
        ...
        static String getActiveEmil() {
            ...
            return GDUtilities.pfs.getString(ACC_NAME, null);
        }

        static Account emil2Accnt(String emil) {
            if (emil != null) {
                Account[] accounts =
                        AccountManager.get(GDUtilities.acx).getAccountsByType(GoogleAuthUtil.GOOGLE_ACCOUNT_TYPE);
        ...
        static int setEmil(String newEmil) {
            ...
            if (result == CHANGED) {
                mCurrEmail = newEmil;
                GDUtilities.pfs.edit().putString(ACC_NAME, newEmil).apply();
            }
            return result;
        }
        ...
        static void removeActiveAccnt() {
            mCurrEmail = null;
            GDUtilities.pfs.edit().remove(ACC_NAME).apply();
        }
    }
